...
import com.vishalag53.androidtrivia.databinding.FragmentGameBinding
    ...
    override fun onCreateView(
        ...
        binding.submitBtn.setOnClickListener { view: View ->
            ...
            if (-1 != checkedId) {
                var answerIndex = 0
                when (checkedId) {
                    R.id.SecondAnswerRadioBtn -> answerIndex = 1
                    R.id.thirdAnswerRadioBtn -> answerIndex = 2
                    R.id.fourthAnswerRadioBtn -> answerIndex = 3
                }
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                        ...
                        view.findNavController().navigate(
                            GameFragmentDirections.actionGameFragment3ToGameWonFragment(
                                numQuestions,
                                questionIndex
                            )
                        )
                    ...
                    view.findNavController()
                        .navigate(GameFragmentDirections.actionGameFragment3ToGameOverFragment2())
                }
            }
        }
        return binding.root
